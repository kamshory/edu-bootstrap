...
?>
<input type="button" name="check" id="check" class="btn btn-success submit-test-button" href="#check-answer" data-rel="popup" value="Periksa Jawaban" />
<input type="button" name="save" id="save" class="btn btn-success submit-test-button" value="Kirim Jawaban" onclick="submitTest($(this).closest('form'))"/>
