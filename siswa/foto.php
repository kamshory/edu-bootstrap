...
{
	$avatar_dir = dirname(__DIR__) . "/media.edu/school/$school_id/user.avatar/student/$student_id";
	$dir2prepared = dirname(__DIR__) . "/media.edu/school/$school_id/user.avatar/student/$student_id";
