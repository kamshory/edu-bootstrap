...
<title>Anda Bukan Siswa - <?php echo $cfg->app_name;?></title>
...
<p>Anda tidak terdaftar sebagai siswa di <?php echo $cfg->app_name;?>. Jika Anda pernah terdaftar sebagai siswa, <a href="ganti-sekolah.php">silakan pilih sekolah</a>. Jika Anda belum pernah terdaftar sebelumnya, silakan menghubungi sekolah Anda agar Anda didaftarkan sebagai siswa. Jika sekolah Anda belum bergabung dengan <?php echo $cfg->app_name;?>, silakan ajukan kepada kepala sekolah Anda untuk bergabung di <?php echo $cfg->app_name;?>. Semua layanan <?php echo $cfg->app_name;?> adalah gratis untuk selamanya.</p>
