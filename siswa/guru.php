...
{
?>
<div class="alert alert-warning">Data tidak ditemukan. <a href="<?php echo 'guru.php';?>">Klik di sini untuk kembali.</a></div>	
<?php
}
...
<div class="col-md-6 col-sm-12 search-pagination-label"><?php echo $pagination->getResultInfo();?></div>
  ...
  <thead>
    ...
    <tr class="<?php echo $picoEdu->getRowClass($data);?>">
      ...
      <td><a href="<?php echo $picoEdu->gateBaseSelfName();?>?option=detail&teacher_id=<?php echo $data['teacher_id'];?>"><?php echo $picoEdu->selectFromMap($data['gender'], array('M'=>'L', 'W'=>'P'));?></a></td>
      </tr>
    <?php
	}
	?>
