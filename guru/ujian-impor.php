...
<table width="100%" border="0" class="table two-side-table responsive-tow-side-table" cellspacing="0" cellpadding="0">
    <tr>
      <td></td>
      <td><input type="submit" name="import" id="import" class="btn btn-success" value="Impor Soal" onclick="window.location='<?php echo $picoEdu->gateBaseSelfName();?>?option=edit&test_id=<?php echo $data['test_id'];?>'" />
...
<div class="col-md-6 col-sm-12 search-pagination-label"><?php echo $pagination->getResultInfo();?></div>
  ...
  <thead>
    ...
    <tr class="<?php echo $picoEdu->getRowClass($data);?>">
      <td><a href="<?php echo $picoEdu->gateBaseSelfName();?>?option=edit&test_id=<?php echo $data['test_id'];?>"><i class="fas fa-file-import"></i></a></td>
