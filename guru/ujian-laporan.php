...
?>
  ...
  <thead>
	...
	?>
    <tr class="row-data<?php echo $picoEdu->ifMatch($data['lewat'] > 0, ' data-error', '');?>">
...
<table width="100%" border="0">
  <tr>
    ...
    <td>Dibuka</td>
    <td><?php echo $picoEdu->ifMatch($info['available_from'] != '0000-00-00 00:00:00' && $info['available_from'] != '', translateDate(date(\Pico\PicoConst::FULL_DATE_TIME_INDONESIA_FORMAT, strtotime($info['available_from']))), '-');?> </td>
    <td>Benar</td>
  ...
  <tr>
    ...
    <td>Ditutup</td>
    <td><?php echo $picoEdu->ifMatch($info['available_to'] != '0000-00-00 00:00:00' && $info['available_to'] != '', translateDate(date(\Pico\PicoConst::FULL_DATE_TIME_INDONESIA_FORMAT, strtotime($info['available_to']))), '-');?> </td>
    <td>Salah</td>
  ...
  <tr>
    ...
    <td><?php echo $picoEdu->ifMatch($info['publish_answer'], translateDate(date(\Pico\PicoConst::FULL_DATE_TIME_INDONESIA_FORMAT, strtotime($info['time_answer_publication']))), '-');?> </td>
    <td>Nilai Awal</td>
...
<span class="option-circle<?php echo $picoEdu->trueFalse($data2['score'] > 0, ' option-circle-selected', '');?>"><?php
	echo $data2['score']*1;
	?></span>
<div class="list-option-item<?php echo $picoEdu->trueFalse($data2['my_answer'] > 0, ' list-option-item-selected', '');?>">
...
<form name="rowform" method="post" action="">
  ...
  <thead>
    <tr>
        <td width="16"><img src="<?php echo $cfg->base_assets;?>lib.tools/images/excel.png" /></td>
        <td width="16"><img src="<?php echo $cfg->base_assets;?>lib.tools/images/excel.png" /></td>
        <td width="25">No</td>
        <td>Ujian</td>
        <td>Kelas</td>
