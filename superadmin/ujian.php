...
if(isset($_POST['save']) && @$_GET['option'] == 'edit')
{
	...
	`question_per_page` = '$question_per_page', `random` = '$random', `random_option` = '$random_option', 
	`random_distribution` = '$random_distribution', `duration` = '$duration', `has_alert` = '$has_alert', 
...
<form name="formedu_test" id="formedu_test" action="" method="post" enctype="multipart/form-data">
  <table width="100%" border="0" class="table two-side-table responsive-tow-side-table" cellspacing="0" cellpadding="0">
		...
		<td><label><input type="checkbox" class="input-checkbox" name="has_alert" value="1" id="has_alert"<?php echo $picoEdu->trueFalse($data['has_alert']==1, \Pico\PicoConst::INPUT_CHECKBOX_CHECKED, '');?>> Beri Peringatan</label>
		</td>
		</tr>
