...
<form name="formedu_info" id="formedu_info" action="" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this, 'Wajib')">
	<table width="800" border="0" class="table two-side-table" cellspacing="0" cellpadding="0">
		...
		<td><input type="number" class="form-control input-text input-text-medium" name="info_id" id="info_id" autocomplete="off" /></td>
		</tr>
		<tr>
		...
		<tr>
		<td>Content</td>
		<td><input type="text" class="form-control input-text input-text-long" name="content" id="content" autocomplete="off" /></td>
		</tr>
		<tr>
		<td>Time Create</td>
...
<form name="formedu_info" id="formedu_info" action="" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this, 'Wajib')">
	<table width="800" border="0" class="table two-side-table" cellspacing="0" cellpadding="0">
		<tr>
		<td width="200">Info</td>
		<td><input type="number" class="form-control input-text input-text-medium" name="info_id" id="info_id" value="<?php echo ($data['info_id']);?>" autocomplete="off" /><input type="hidden" name="info_id2" id="info_id2" value="<?php echo ($data['info_id']);?>" /></td>
		</tr>
		<tr>
		<td>Judul Informasi</td>
		...
		<tr>
		<td>Content</td>
		<td><input type="text" class="form-control input-text input-text-long" name="content" id="content" value="<?php echo $data['content'];?>" autocomplete="off" /></td>
		</tr>
		<tr>
		<td>Time Create</td>
		...
		<tr>
		<td>Aktif</td>
		<td><label><input type="checkbox" class="input-checkbox" name="active" value="1" id="active"<?php echo $picoEdu->ifMatch($data['active'], true, ' checked="checked"');?>> Active</label>
		</td>
		</tr>
		<tr><td>&nbsp;</td>
		<td><input type="submit" name="save" id="save" class="btn com-button btn-success" value="Simpan" /> <input type="button" name="showall" id="showall" value="Tampilkan Semua" class="btn com-button btn-success" onclick="window.location='<?php echo basename($_SERVER['PHP_SELF']);?>'" /></td>
