...
<title>Anda Bukan Super Administrator - <?php echo $cfg->app_name;?></title>
...
<p>Anda tidak terdaftar sebagai super administrator di <?php echo $cfg->app_name;?>. </p>
<p><a href="../">Klik di sini untuk kembali ke depan</a></p>
</div>
</div>
</body>
</html>