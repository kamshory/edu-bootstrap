...
<h4><?php echo $data['name'];?> <button type="button" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#detail-test-modal">
...
<script src="../lib.assets/script/test-ws-teacher.js"></script>
