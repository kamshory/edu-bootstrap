...
<div class="button-area">
  ...
  <input type="button" name="print" id="print" value="Cetak Password" class="btn btn-primary" onclick="window.open('<?php echo basename($_SERVER['PHP_SELF']);?>?option=print-password')" />
  </div>
</form>
<?php
}
