			...
			if(count($questions))
			{
				...
				<tfoot>
					...
					<div class="button-area">
						...
						<input type="button" class="btn btn-primary" id="reload-dialog" value="Muat Ulang" onclick="distribution(<?php echo $test_id;?>)">
						<input type="submit" class="btn btn-success" id="save-dialog" value="Simpan">
						<input type="button" class="btn btn-secondary" id="close-dialog" value="Batal" onclick="closeOverlayDialog()">
					</div>
				</form>    
				</div>
				<?php
