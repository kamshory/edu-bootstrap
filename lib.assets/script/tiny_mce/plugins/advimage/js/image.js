var ImageDialog = {
	preInit : function() {
		...
		if (url = tinyMCEPopup.getParam("external_image_list_url"))
			document.write('<script type="text/javascript" type="text/javascript" src="' + tinyMCEPopup.editor.documentBaseURI.toAbsolute(url) + '"></script>');
	},
		...
		function onPasteTriggered(e) {
			...
			if(copiedData.type.indexOf("image") == 0) {
				...
				reader.onload = function (evt) {
					...
					img2.src = result;
					document.getElementById('src').value = result;
					document.getElementById('prev').appendChild(img2);
					
					document.getElementById("paste_image").appendChild(img);
				};
